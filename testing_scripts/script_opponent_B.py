...
def ActPirate(pirate):
    ...
    if (checkIsland(pirate) and (_id % 8 == 0 or _id % 8 == 1 or _id % 8 == 2)) and pirate.getSignal()[1] == "s":
        ...
        if (up == ("island1" or "island2" or "island3") and pirate.investigate_up()[1] == (
        "enemy") and pirate.getTotalGunpowder() > 100):
            return 1
        if (down == ("island1" or "island2" or "island3") and pirate.investigate_down()[1] == (
        "enemy") and pirate.getTotalGunpowder() > 100):
            return 3
        if (left == ("island1" or "island2" or "island3") and pirate.investigate_left()[1] == (
        "enemy") and pirate.getTotalGunpowder() > 100):
            return 4
        if (right == ("island1" or "island2" or "island3") and pirate.investigate_right()[1] == (
        "enemy") and pirate.getTotalGunpowder() > 100):
            return 2
    ...
    if (up == ("island1" or "island2" or "island3") and pirate.investigate_up()[1] == (
    "enemy") and pirate.getTotalGunpowder() > 100 and checkIsland(pirate) == True):
        return 1
    if (down == ("island1" or "island2" or "island3") and pirate.investigate_down()[1] == (
    "enemy") and pirate.getTotalGunpowder() > 100 and checkIsland(pirate) == True):
        return 3
...
def scout(pirate):  # ,team):
    if pirate.getSignal()[1] == "s" and pirate.getTotalGunpowder() < 300 and int(
            pirate.getTeamSignal().split(',')[12]) < 20:
        pirate.setSignal(pirate.getSignal()[0] + " " + pirate.getSignal()[2:])
    if pirate.getSignal()[1] != "s" and pirate.getTotalGunpowder() > 600 and int(
            pirate.getTeamSignal().split(',')[12]) > 45:
